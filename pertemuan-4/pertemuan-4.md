...
> **Catatan**: Seluruh 23 data outlier di atas dihapus dan diubah menjadi NaN agar tidak membiaskan proses interpolasi. Rincian tanggal dan nilai ke-23 titik outlier tersimpan lengkap di berkas data/csv/pertemuan-4-csv/polutan_4_outliers_list.csv.u (*time series*) untuk **4 parameter polutan udara utama** di Kabupaten Bangkalan: **Metana ($\text{CH}_4$)**, **Karbon Monoksida ($\text{CO}$)**, **Nitrogen Dioksida ($\text{NO}_2$)**, dan **Sulfur Dioksida ($\text{SO}_2$)**. 
...
> **Catatan**: Matriks lengkap berisi seluruh 68 fitur TSFEL untuk ke-4 polutan tersimpan pada berkas data/csv/pertemuan-4-csv/fitur_68_4_polutan.csv. ini menyajikan alur pemrosesan data deret waktu (*time series*) untuk **4 parameter polutan udara utama** di Kabupaten Bangkalan: **Metana ($\text{CH}_4$)**, **Karbon Monoksida ($\text{CO}$)**, **Nitrogen Dioksida ($\text{NO}_2$)**, dan **Sulfur Dioksida ($\text{SO}_2$)**. 
